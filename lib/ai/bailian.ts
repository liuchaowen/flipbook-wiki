...
// 等轴测插画风格修饰词 - 统一风格和色彩，确保中文文字正确显示
const ISOMETRIC_STYLE = 'isometric illustration style,isometric projection, dimensional feel, geometric shapes, clean modern design, soft pastel color palette with blue, teal, coral and warm orange accents, consistent lighting, infographic style, clean layout, icons and illustrations, educational, visual organization, labeled sections, vector art style, smooth gradients, professional infographic design. IMPORTANT: All text labels and annotations in the image MUST be displayed in clear, readable Chinese characters (中文). Text must be crisp, legible, and properly formatted without any garbled characters, distortion, or visual artifacts. Use appropriate font sizes and spacing for Chinese text readability.';
// 尺寸映射
          ...
          messages: [
            {
              role: 'user',
              content: [
                { text: `你是一个图像分析专家，擅长识别图像中的特定区域。当给定一张图像和点击位置时，你需要识别点击了哪个元素或区域，并提供关于它的详细信息。
